...
const CardBlogComponent: FC<CardBlogProps> = ({
	...
	return (
		<li className="flex flex-col-reverse justify-center items-center w-full gap-5 p-4 bg-secondary-400 animate-appear sm:flex-row sm:justify-start sm:items-start">
